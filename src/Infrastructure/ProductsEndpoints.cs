...
public static class ProductsEndpoints
{
    public static void MapProductsEndpoints(this IEndpointRouteBuilder endpoints)
    {
        ...
        endpoints.MapPost("/products", async (IMediator mediator, ProductRequest request) =>
        {
        ...
        endpoints.MapPut("/products/{id}", async (IMediator mediator, Guid id, ProductRequest request) =>
        {
